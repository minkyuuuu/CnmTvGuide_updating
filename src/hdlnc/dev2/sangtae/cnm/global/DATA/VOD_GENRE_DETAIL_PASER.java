...
public class VOD_GENRE_DETAIL_PASER {
	// URL
	...
	private final static String XML_VOD_ITEM = "vod_Item";
	// deth 3
	...
	private static VOD_GENRE_DETAIL_LIST mArrayList;

	public VOD_GENRE_DETAIL_PASER(String url) {
		// TODO Auto-generated constructor stub
		mArrayList	=	new VOD_GENRE_DETAIL_LIST();
		XML_URI = url;
	}
		...
		try {
			...
			while (eventType != XmlPullParser.END_DOCUMENT) {
				if(eventType == XmlPullParser.START_DOCUMENT) {
					...
					Log.d("VOD_PREVIEW_PASER", "Start tag : "+xpp.getName());
					...
					if (xpp.getName().equals(XML_RESULT_CODE)) {
						...
						eventType = xpp.next();
						Log.d("VOD_PREVIEW_PASER", "getText : "+xpp.getText());
						if(xpp.getText() != null)
						mArrayList.get(mCurrentCount).setID(xpp.getText());
						...
						Log.d("VOD_PREVIEW_PASER", "getText : "+xpp.getText());
						if(xpp.getText() != null)
						mArrayList.get(mCurrentCount).setMore(xpp.getText());
						eventType = xpp.next();
						...
						Log.d("VOD_PREVIEW_PASER", "getText : "+xpp.getText());
						if(xpp.getText() != null)
						mArrayList.get(mCurrentCount).setGrade(xpp.getText());
						eventType = xpp.next();
					} else if (xpp.getName().equals(XML_VOD_POSTER_URL)) {
						eventType = xpp.next();
						Log.d("VOD_PREVIEW_PASER", "getText : "+xpp.getText());
						if(xpp.getText() != null)
						mArrayList.get(mCurrentCount).setPosterUrl(xpp.getText());
						eventType = xpp.next();
						...
						Log.d("VOD_PREVIEW_PASER", "getText : "+xpp.getText());
						if(xpp.getText() != null)
						mArrayList.get(mCurrentCount).setVideoUrl(xpp.getText());
						eventType = xpp.next();
					} else if (xpp.getName().equals(XML_VOD_TAG)) {
						eventType = xpp.next();
						Log.d("VOD_PREVIEW_PASER", "getText : "+xpp.getText());
						if(xpp.getText() != null)
						mArrayList.get(mCurrentCount).setTag(xpp.getText());
						eventType = xpp.next();
					} else if (xpp.getName().equals(XML_VOD_HD)) {
						eventType = xpp.next();
						Log.d("VOD_PREVIEW_PASER", "getText : "+xpp.getText());
						if(xpp.getText() != null)
						mArrayList.get(mCurrentCount).setHD(xpp.getText());
						eventType = xpp.next();
	...
	public static VOD_GENRE_DETAIL_LIST getArrayList() {
		return mArrayList;
	}
}
