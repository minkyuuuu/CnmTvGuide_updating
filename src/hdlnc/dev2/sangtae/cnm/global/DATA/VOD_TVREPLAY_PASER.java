...
public class VOD_TVREPLAY_PASER {
	// URL
...
//	private final static String XML_ROOT = "Root";
	private final static String XML_ROOT = "Tv_Root";
	// deth 2
	private final static String XML_RESULT = "resultCode";
	private final static String XML_VOD_ITEM = "Tv_Item";
//	private final static String XML_VOD_ITEM = "Item";
	...
	private static VOD_TVREPLAY_LIST mArrayList;

	public VOD_TVREPLAY_PASER(String url) {
		...
		try {
			...
			while (eventType != XmlPullParser.END_DOCUMENT) {
				if(eventType == XmlPullParser.START_DOCUMENT) {
					...
					mArrayList	=	new VOD_TVREPLAY_LIST();
	...
	public static VOD_TVREPLAY_LIST getArrayList() {
		return mArrayList;
	}
}
