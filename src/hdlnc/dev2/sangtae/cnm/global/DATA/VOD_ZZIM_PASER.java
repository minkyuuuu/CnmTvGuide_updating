...
//	private final static String XML_ROOT = "Root";
	//private final static String XML_ROOT = "MyVod_Root";
	// deth 2
	private final static String XML_RESULT_CODE = "resultCode";
	private final static String XML_VOD_ITEM = "MyVod_Item";
	// deth 3
	...
	private static VOD_ZZIM_LIST mArrayList;
		...
		try {
			...
			while (eventType != XmlPullParser.END_DOCUMENT) {
				if(eventType == XmlPullParser.START_DOCUMENT) {
					...
					if (xpp.getName().equals(XML_RESULT_CODE) || xpp.getName().equals("Result")
	...
	public static VOD_ZZIM_LIST getArrayList() {
		return mArrayList;
	}
}
