...
public class VOD_NEWMOVIE_PASER {
	
	
	private final static String DEBUG_TAG = "VOD_NEWMOVIE_PASER";
	// URL
	private static String XML_URI	=	"";

	// XML Depth
	// ROOT 1
	private final static String XML_ROOT = "NewMovie_Root";
	// depth 2
	private final static String XML_RESULT_CODE = "resultCode";
	private final static String XML_VOD_ITEM = "NewMovie_Item";
	// depth 3
	...
	private static VOD_NEWMOVIE_LIST mArrayList;

	public VOD_NEWMOVIE_PASER(String url) {
		...
		try {
			...
			while (eventType != XmlPullParser.END_DOCUMENT) {
				if(eventType == XmlPullParser.START_DOCUMENT) {
					...
					mArrayList	=	new VOD_NEWMOVIE_LIST();
	...
	public static VOD_NEWMOVIE_LIST getArrayList() {
		return mArrayList;
	}
}
