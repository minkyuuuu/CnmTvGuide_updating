...
public class CoverflowImageDownloader {
	...
	private static final String DEBUG_TAG = "CoverflowImageDownloader";
	...
	public void setContext(Context mContext) {
		CoverflowImageDownloader.mContext = mContext;
	}
...
//		mLoadingImage = ReflectedImageCreator.createReflectedImages(loadingImage, 5);
	...
	class BitmapDownloaderTask extends AsyncTask<String, Void, Bitmap> {
		...
		protected Bitmap doInBackground(String... params) {
			...
			if (!file.exists())
 				return ReflectedImageCreator.createReflectedImages(downloadBitmap(url), 5);
...
//						AsyncCheckFlag = false;
		...
		protected void onPreExecute() {
			...
			Log.d(DEBUG_TAG, "ThreadCounter : " + ThreadCounter);
			...
			if (entity != null) {
				...
				try {
				  ...
				  byte[] data = os.toByteArray();
				   ...
				   {
					   Log.i(DEBUG_TAG, "inSampleSize 2");
					   bitmap.recycle();
				   ...
				   {
					   Log.i(DEBUG_TAG, "inSampleSize 3");
					   bitmap.recycle();
				   ...
				   {
					   Log.i(DEBUG_TAG, "inSampleSize 4");
					   bitmap.recycle();
