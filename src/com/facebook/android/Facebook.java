...
public class Facebook {
	...
	public void authorize(Activity activity, String[] permissions,
		...
		Log.d("Facebook-authorize", "call authorize" );
...
//        }
	...
	private boolean startSingleSignOn(Activity activity, String applicationId,
        ...
        Log.d("Facebook-authorize", "call startSingleSignOn" );
        ...
        Log.d("Facebook-authorize", "call didSucceed : " + didSucceed);
        return didSucceed;
    }
	...
	private boolean validateAppSignatureForIntent(Activity activity,
			Intent intent) {
		Log.d("Facebook-authorize", "call validateAppSignatureForIntent" );
	...
	private void startDialogAuth(Activity activity, String applicationId,
		...
		Log.d("Facebook-authorize", "call startDialogAuth" );
